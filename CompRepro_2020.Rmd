...
One of the ways the ways the authors suggest as a good practice for computational reproducibility is keeping track of changes. Tools like Github offer an easy way to keep track of changes and to manage version control when collaborating with other people. More specifically, they suggest 1. backing up as much as possible, 2. keeping changes small, 3. sharing changes frequently, i.e. for Github, this would be pushing changes frequently, 4. explaining changes in a checklist or log file, and 5. storing projects in a folder that synchronizes with the working machine. 
